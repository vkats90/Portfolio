	...
	return (
		<div className="z-0 h-[100vh] bg-[#EAEFF5]">
			...
			<div className="relative z-10 w-fit md:left-[15%] top-[40%] text-center m-auto md:m-0">
				<h1 className="text-3xl md:text-6xl">VLADIMIR KATS</h1>
			...
			<div className="relative top-[85%] text-center -mt-14 md:mt-0 mx-auto max-w-[90%] md:max-w-[50%] border-2 shadow-lg shadow-black/50 border-primary rounded-lg  overflow-hidden">
