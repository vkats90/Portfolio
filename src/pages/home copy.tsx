...
const Home = () => {
  ...
  const { ref: inViewRef4, inView: inView4, entry } = useInView()

  const setRefs = useCallback(
    (ref: HTMLDivElement | null, inViewRef: (node?: HTMLDivElement | null) => void) => {
      if (ref) {
        inViewRef(ref)
      }
    },
    [inViewRef1, inViewRef2, inViewRef3, inViewRef4]
  )
  ...
  useEffect(() => {
    ...
    console.log(entry)
  }, [inView1, inView2, inView3, entry])
  return (
    <div className="z-0 h-full pb-80" ref={(ref) => setRefs(ref, inViewRef4)}>
      ...
      >
        ...
        <p className="relative p-5 text-lg text-left z-10 text-gray-700">
          Passionate and driven web developer with a strong foundation in full-stack development and
          a proven track record in e-commerce and operations management. With hands-on experience in
          Frontend and Backend development using the latest technologies such as TypeScript,
          React.js, GraphQL, Node.JS and MongoDB, I have built and maintained dynamic web
          applications, including an interactive game portal and an inventory management API. My
          background in automating processes with VBA macros sparked my interest in web development,
          leading me to a 2 year journey of self-learning completing the Full Stack Open Online
          Course from the University of Helsinki and the freeCodeCamp online course. I am eager to
          bring my skills in modern web development to a forward-thinking team, where I can
          contribute to building innovative solutions and driving digital growth. Let's connect and
          explore how I can add value to your web development projects.
        </p>
      </div>
