  ...
  return (
    <InView rootMargin="-100px 0px">
      {({ inView: inView1, ref: ref1 }) => (
        <div
          ref={ref1}
          className={`relative max-w-[90%] w-96 rounded border-2 border-primary h-fit min-h-[700px] shadow-md bg-white/40 text-left transition duration-300 ease-in ${
            inView1 ? 'opacity-1' : 'opacity-0 translate-x-10 blur-md'
          }`}
        >
          <img
